...
def select_character_names_and_number_of_books_they_are_in
  "SELECT character_id, count(*) FROM character_books JOIN characters ON character_books.character_id = characters.id GROUP BY character_id ORDER BY count(*) DESC;"
end
